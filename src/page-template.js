  ...
  return`
    <section class="my-3" id="portfolio">
      ...
      ${projectsArr
        ...
        .map(({ nombre, description, languages, linkRepo, linkSite}) => {
          return `
          <div class="col-12 mb-2 bg-dark text-light p-3 flex-column">
            <h3 class="portfolio-item-tittle text-light">${nombre}</h3>
...
<head>
  ...
  <title>Portfolio - ${header.nombre}</title>
...
<body>
  <header>
    <div class="container flex-row justify-space-between align-center py-3">
      <h1 class="page-title text-secondary bg-dark py-2 px-3">${header.nombre}</h1>
      <nav class="flex-row">
  ...
  <footer class="container text-center py-3">
    <h3 class="text-dark">&copy; ${new Date().getUTCFullYear()} by ${header.name}</h3>
  </footer>
</body>
</html>
`;
